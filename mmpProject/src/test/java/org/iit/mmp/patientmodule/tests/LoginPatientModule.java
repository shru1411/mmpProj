...
public class LoginPatientModule extends TestBase{
	...
	@Test(dataProvider="testData1", description="US_002_Login_Patient",groups={"US_002","regression","sanity","patientmodule"})
	...
	public  Object[][] getData() {
		...
		String excelPath=str + "\\src\\test\\resources\\excel\\LoginData.xlsx";
	...
	{
		util.ExcelUtils(excelPath, sheetName);

		//ExcelUtils excel=new ExcelUtils(excelPath,sheetName);		
		int rowCount= util.getRowCount();
		int colNum= util.getcolCount();
